...
#'
#' This function allows you to test the distributions of response variables and output per response variable the nearest GLM family. The assumption is that the means of kurtosis and square of skewness represent the geometrical center of the distributions.
